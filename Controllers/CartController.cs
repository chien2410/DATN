        ...
        public ActionResult CheckOut(CustomerViewModel req)
        {
            ...
            if (ModelState.IsValid)
            {
                ...
                if (cart != null)
                {
                    ...
                    ShopDGHouse.Common.Common.SendMail("ShopDGHouse", "Đơn hàng #" + dh.Id.ToString(), contentCustomer.ToString(), dh.Email);
                    ...
                    ShopDGHouse.Common.Common.SendMail("ShopDGHouse", "Đơn hàng #" + dh.Id.ToString(), contentAdmin.ToString(), ConfigurationManager.AppSettings["EmailAdmin"]);
                    cart.ClearCart();
